...
# JerryPipe, but only run to test the necesity of prinseq
    # Designed to process RNA sequencing data
    # Hardcoded to run only the 4 samples
...
refGenome = "/n/data1/hms/dbmi/farhat/Jerry/References/GCF_000195955.2_ASM19595v2_genomic.fasta"
    # Absolute path to the H37RV genome
scratchDir = "/n/scratch2/jy250/testPrinseq/"
samFolder = "/n/scratch2/jy250/testPrinseq/samFiles/" 
bamFolder = "/n/scratch2/jy250/testPrinseq/bamFiles/" 
cleanedFastqFolder = "/n/scratch2/jy250/testPrinseq/cleanedFastqs/"
inputFolder = "/n/scratch2/jy250/testPrinseq/"  # /n/scratch2/jy250/test100/" # 
vcfFolder = "/n/scratch2/jy250/testPrinseq/"
slurmFolder = "/n/scratch2/jy250/testPrinseq/slurmLogs/"
countsFolder = "/n/scratch2/jy250/testPrinseq/counts/"
lineageFolder = "/n/scratch2/jy250/testPrinseq/lineageCalls/"
...
def submitSlurmScript(commands_list, outputName = None):
    ...
    if outputName is not None:
        sCommand = 'sbatch -p priority -c 1 -t 0-11:59 --mem=100G --mail-user=Jerry_Yang@hms.harvard.edu \
